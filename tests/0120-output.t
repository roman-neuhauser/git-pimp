...
::
  ...
  git format-patch --output-directory=. --cover-letter --thread --to=git-pimp-tests-sink@example.org up/master..rn/feature
  ...
  git format-patch --output-directory=out1 --cover-letter --thread --to=git-pimp-tests-sink@example.org up/master..rn/feature
  ...
  git format-patch --output-directory=out2 --cover-letter --thread --to=git-pimp-tests-sink@example.org up/master..rn/feature
